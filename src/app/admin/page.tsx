      ...
      <div className="min-h-screen bg-[#0F0F0F] flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-white/40 text-xs mt-1 uppercase tracking-wider">Google ADK · Gemini 2.0 · Live Store Data</p>
          </div>
    ...
    <div className="min-h-screen bg-[#F5F5F0] flex flex-col">
      ...
      <div className="bg-[#0F0F0F] px-6 py-4 flex items-center gap-3 shrink-0">
        ...
        <div>
          ...
          <p className="text-white/40 text-[10px] uppercase tracking-wider">Google ADK · Gemini 2.0 · Live Data</p>
        </div>
      ...
      <div className="bg-white border-t border-[#E5E7EB] px-4 py-4 shrink-0">
        ...
        <p className="text-center text-[10px] text-[#9CA3AF] mt-2 uppercase tracking-widest">
          NOVA Admin · Google ADK + Gemini 2.0 · Data fetched live on every query
        </p>
      </div>
    </div>
  );
