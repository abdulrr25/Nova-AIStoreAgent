...
public class DataSeeder implements CommandLineRunner {
    ...
    public void seedAll() {
        ...
        productRepository.saveAll(List.of(
            // ── Smartphones ──
            p("Apple iPhone 15 Pro Max",         "6.7-inch Super Retina XDR, A17 Pro chip, 48 MP camera with 5x optical zoom, Titanium design.",               159900, img("1695048133142-1a20484bce71"), electronics, null, "Natural Titanium,Blue Titanium,White Titanium,Black Titanium"),
            ...
            p("Google Pixel 8 Pro",              "6.7-inch LTPO OLED, Tensor G3, 50 MP triple camera with Magic Eraser and Best Take.",                         106999, img("1598327105854-0d9e8eadab53"), electronics, null, "Obsidian,Porcelain,Bay"),
            ...
            p("Xiaomi 14",                       "6.36-inch 1.5K LTPO AMOLED, Snapdragon 8 Gen 3, Leica optics, 90 W HyperCharge.",                             69999, img("1580910051074-3eb694886f2b"), electronics, null, "Black,White,Jade Green"),
            ...
            p("MacBook Pro 14\" M3 Pro",         "14.2-inch Liquid Retina XDR, M3 Pro chip, 12-core CPU, ProMotion 120 Hz.",                                    199900, img("1517336714428-95c9613be35c"), electronics, null, "Space Black,Silver"),
            ...
            p("Lenovo ThinkPad X1 Carbon Gen 11","14-inch 2.8K OLED, Intel Core i7-1365U, 32 GB RAM, fingerprint reader, MIL-STD tested.",                      154990, img("1531297484001-80022131f9b1"), electronics, null, "Black"),
            ...
            p("Apple AirPods Pro 2",             "H2 chip, adaptive transparency, personalized spatial audio, MagSafe case.",                                    24900, img("1588423771073-b8903fba2be4"), electronics, null, "White"),
            ...
            p("JBL Tune 770NC",                  "Adaptive noise cancelling, JBL Pure Bass, 44-hour battery, foldable design.",                                    5999, img("1583394838336-d6a3ab7a9fcb"), electronics, null, "Black,Blue,Purple"),
            p("Marshall Major IV",               "80+ hours battery, wireless charging, iconic design, custom-tuned drivers.",                                    12999, img("1484704849700-f282b8ee10d0"), electronics, null, "Black,Brown"),
            ...
            p("GoPro HERO 12 Black",             "5.3K60 video, HyperSmooth 6.0, HDR photo, Max Lens Mod 2.0, waterproof 10 m.",                                 44990, img("1526170375885-4d8ecf76d4c8"), electronics, null, "Black"),
        ...
        productRepository.saveAll(List.of(
            ...
            p("Levi's Classic Western Shirt",    "Pearl snap buttons, pointed yoke, cotton denim, relaxed fit.",                                                    3999, img("1596755094514-5c7c0b16a1db"), clothing, "S,M,L,XL,XXL", "Light Wash,Medium Wash,Black"),
            ...
            p("North Face Puffer Jacket",        "700-fill goose down, water-resistant DWR finish, packable design.",                                               12999, img("1544022613136-35cf9c5b6a39"), clothing, "S,M,L,XL,XXL", "Black,Navy,Olive,Burgundy"),
            ...
            p("Tommy Hilfiger Leather Belt",     "Full-grain leather, signature flag buckle, stitched edges, 35 mm width.",                                          2499, img("1553062407-98d43420e9e7"), clothing, "30,32,34,36,38,40", "Brown,Black,Tan"),
            p("Nike Heritage Backpack",          "Polyester fabric, padded shoulder straps, front zip pocket, 25 L capacity.",                                       2999, img("1553062407-98d43420e9e7"), clothing, "Free Size", "Black,Navy,Grey,Olive"),
            // ── Premium ──
            p("Polo Ralph Lauren Cable Knit Sweater","100% cotton cable knit, crew neck, ribbed trim, signature pony.",                                             8999, img("1556821840-3a63f15732ce"), clothing, "S,M,L,XL,XXL", "Navy,Grey,Burgundy,Green"),
            ...
            p("Columbia Outdoor Fleece Jacket",  "MTR fleece, full zip, zippered hand pockets, drawcord hem.",                                                       4999, img("1544022613136-35cf9c5b6a39"), clothing, "S,M,L,XL,XXL", "Black,Charcoal,Navy,Olive"),
            ...
            p("Marks & Spencer Pure Linen Shirt","100% linen, regular fit, button-down collar, chest pocket.",                                                       2999, img("1596755094514-5c7c0b16a1db"), clothing, "S,M,L,XL,XXL", "White,Sky Blue,Beige,Sage Green")
        ));
        ...
        productRepository.saveAll(List.of(
            ...
            p("1984",                            "George Orwell's chilling dystopian masterpiece about surveillance, propaganda and Big Brother.",                    249, img("1543002588-bfa74002ed7c"), books, null, null),
            ...
            p("To Kill a Mockingbird",           "Harper Lee's Pulitzer Prize-winning novel exploring racial injustice through a child's eyes.",                      299, img("1476275466078-f5ba7c55cc71"), books, null, null),
            ...
            p("Think and Grow Rich",             "Napoleon Hill's classic on the power of thought, persistence and burning desire.",                                  299, img("1519682337058-a94d519bcd9e"), books, null, null),
            ...
            p("Steve Jobs by Walter Isaacson",   "The definitive biography of Apple's visionary co-founder based on 40+ interviews.",                                 649, img("1467803738586-46b7eb7b16a9"), books, null, null),
            p("Elon Musk by Walter Isaacson",    "The intimate biography of the most daring entrepreneur of our time.",                                               799, img("1476275466078-f5ba7c55cc71"), books, null, null),
            ...
            p("Educated by Tara Westover",       "A memoir of a woman who grows up in a survivalist family and earns a PhD from Cambridge.",                          449, img("1543002588-bfa74002ed7c"), books, null, null),
            ...
            p("The Art of War",                  "Sun Tzu's 2500-year-old guide to strategy, leadership and competitive advantage.",                                  199, img("1524995997946-a1bd659b37b3"), books, null, null),
        ...
        productRepository.saveAll(List.of(
            ...
            p("KitchenAid Stand Mixer",          "5-quart stainless steel bowl, 10-speed, tilt-head design, planetary mixing action.",                              29999, img("1594631252845-29fc4cc8c3e4"), home, null, "Empire Red,Onyx Black,White,Silver"),
            ...
            p("Glass Storage Jar Set 12-pc",     "Airtight borosilicate glass jars with bamboo lids, stackable design.",                                             1899, img("1544785349-c4e4776a6b76"), home, null, "Clear"),
            ...
            p("Floating Wall Shelf Set",         "Set of 3 MDF shelves with invisible brackets, 10 kg load capacity each.",                                          1499, img("1558618047-f4e90e8cef30"), home, null, "White,Walnut,Oak"),
            ...
            p("Robot Vacuum Cleaner",            "LiDAR mapping, 2700 Pa suction, auto-empty dock, works on carpet and hardwood.",                                   19999, img("1625751363006-5b07c56b018e"), home, null, "Black,White"),
            ...
            // ── Storage ──
            p("Foldable Wardrobe Organiser",     "6-shelf hanging organiser, reinforced shelves, breathable fabric, 30 x 30 x 128 cm.",                               799, img("1558618047-f4e90e8cef30"), home, null, "Grey,Beige"),
            p("Under-Bed Storage Box Set",       "Set of 2 boxes with lids, clear window, handles, moisture-proof fabric.",                                            999, img("1558618047-f4e90e8cef30"), home, null, "Grey,White"),
            p("Stackable Shoe Rack 5-Tier",      "Steel frame, non-woven fabric shelves, holds 15 pairs, easy assembly.",                                             1499, img("1558618047-f4e90e8cef30"), home, null, "Black,Grey"),
            // ── Kitchen Tools ──
        ...
        productRepository.saveAll(List.of(
            ...
            p("Doorframe Pull-Up Bar",           "No screws needed, fits doors 60-100 cm, holds up to 120 kg, foam grips.",                                          1299, img("1517963879433-6ad2a04b9d9a"), sports, null, "Black,Silver"),
            p("Kettlebell 16kg Cast Iron",       "Single-piece cast iron, flat base for stability, powder-coat finish.",                                              2499, img("1517344800994-80b23d030e39"), sports, null, "Black"),
            ...
            // ── Running & Shoes ──
            p("Asics Gel-Nimbus Running Shoes",  "FlyteFoam midsole, GEL cushioning, breathable mesh upper, road running.",                                          11999, img("1539185185060-ef6acf0c2fc6"), sports, "6,7,8,9,10,11", "Black/White,Blue/Orange,Grey/Lime"),
            ...
            p("Wilson Pro Staff Tennis Racket",  "Graphite frame, 16 × 19 string pattern, 315 g, intermediate-advanced.",                                             3999, img("1595435934819-5704aece9c82"), sports, null, "Red/Black,Blue/Black"),
            ...
            p("Harbinger Gym Gloves",            "Full-finger protection, anti-slip silicone grip, wrist wrap support.",                                                999, img("1583454086892-eedc76d54b72"), sports, "S,M,L,XL", "Black,Grey"),
            ...
            p("Assault Air Bike",                "Fan resistance, unlimited intensity, heavy-duty steel frame, LCD console.",                                         39999, img("1517963879433-6ad2a04b9d9a"), sports, null, "Black"),
            ...
            p("Power Tower Dip Station",         "Multi-grip pull-up bar, dip handles, VKR, push-up grips, 150 kg capacity.",                                         8999, img("1517963879433-6ad2a04b9d9a"), sports, null, "Black/Red"),
            ...
            p("Premium Gym Bag 40L",             "Separate shoe compartment, wet pocket, padded shoulder strap, durable nylon.",                                       1999, img("1553062407-98d43420e9e7"), sports, null, "Black,Grey,Navy"),
